...
#merging from and to nodes for each edge
...
#creating the final gdf with from, to, linestring, length, edge id (eid)
...
missing_edge_gpd.to_file(
    '/Users/robertbenassai/Documents/UOC/alertadadesconfidencialsdatosconfidencialesconfid/missing_edges.shp')
#%%
# distr = nx.DiGraph()
